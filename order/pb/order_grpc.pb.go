...
const (
	OrderingService_CreateOrder_FullMethodName   = "/orderpb.OrderingService/CreateOrder"
...
func (c *orderingServiceClient) AddItem(ctx context.Context, in *AddItemRequest, opts ...grpc.CallOption) (*AddItemResponse, error) {
	out := new(AddItemResponse)
	err := c.cc.Invoke(ctx, OrderingService_AddItem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderingServiceServer) AddItem(context.Context, *AddItemRequest) (*AddItemResponse, error) {
...
var OrderingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orderpb.OrderingService",
